...
export class AddTrialPeriod1762886281492 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "temporary_user_settings" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "locale" varchar NOT NULL DEFAULT (''), "region" varchar, "originalLanguage" varchar, "pgpKey" varchar, "sharedLibraries" varchar, "notificationTypes" text, "userId" integer, "allowDownloads" boolean NOT NULL DEFAULT (0), "allowLiveTv" boolean NOT NULL DEFAULT (0), "trialPeriodEndsAt" boolean DEFAULT (true), CONSTRAINT "REL_986a2b6d3c05eb4091bb8066f7" UNIQUE ("userId"), CONSTRAINT "FK_986a2b6d3c05eb4091bb8066f78" FOREIGN KEY ("userId") REFERENCES "user" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`
    );
    await queryRunner.query(
      `INSERT INTO "temporary_user_settings"("id", "locale", "region", "originalLanguage", "pgpKey", "sharedLibraries", "notificationTypes", "userId", "allowDownloads", "allowLiveTv", "trialPeriodEndsAt") SELECT "id", "locale", "region", "originalLanguage", "pgpKey", "sharedLibraries", "notificationTypes", "userId", "allowDownloads", "allowLiveTv", "autoPinLibraries" FROM "user_settings"`
    );
