...
export class CalibreWebIntegration1789420620395 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `INSERT INTO "user"("id", "email", "plexUsername", "username", "password", "resetPasswordGuid", "recoveryLinkExpirationDate", "userType", "plexId", "plexToken", "permissions", "avatar", "inviteQuotaLimit", "inviteQuotaDays", "createdAt", "updatedAt", "redeemedInviteId", "active", "accessRevokedAt", "accessRevokedReason", "plexJwt", "plexJwtExpiresAt", "plexJwtDevice", "audiobookshelfId", "audiobookshelfUsername", "audiobookshelfPassword", "audiobookshelfPwNotifiedAt", "shelfmarkUsername") SELECT "id", "email", "plexUsername", "username", "password", "resetPasswordGuid", "recoveryLinkExpirationDate", "userType", "plexId", "plexToken", "permissions", "avatar", "inviteQuotaLimit", "inviteQuotaDays", "createdAt", "updatedAt", "redeemedInviteId", "active", "accessRevokedAt", "accessRevokedReason", "plexJwt", "plexJwtExpiresAt", "plexJwtDevice", "audiobookshelfId", "audiobookshelfUsername", "audiobookshelfPassword", "audiobookshelfPwNotifiedAt", "shelfmarkUsername" FROM "temporary_user"`
    );
