      ...
      <div className="container mx-auto">
        ...
        <div className="join join-vertical w-full gap-3 rounded-none px-4">
          ...
          <div className="collapse collapse-arrow join-item bg-brand-dark ">
            ...
            <div className="collapse-content">
              <p className="mb-4">
                Plex gives you one place to find and access all the media that
                matters to you. From personal media on your own server, to free
                and on-demand Movies &amp; Shows, live TV, podcasts, and web
                shows, to streaming music, you can enjoy it all in one app, on
                any device.
              </p>
              <p className="mb-4">
              ...
              <p className="mb-4">
                ...
                service or over 100 channels of live TV. Listen to your favorite
                podcasts at home or on your commute. Watch your favorite web
                shows from talented creators around the world. You can even
                access over 60 million streaming music tracks and videos,
                provided by TIDAL!
              </p>
              <p>
          ...
          <div className="collapse collapse-arrow join-item bg-brand-dark ">
            ...
            <div className="collapse-content">
              ...
              <p>
                Using Overseerr, you can request almost anything that&apos;s not
                already available and watch it within minutes.
              </p>
            </div>
          </div>
        </div>
