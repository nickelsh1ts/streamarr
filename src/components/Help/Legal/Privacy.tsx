  ...
  return (
    <div className="container my-5 text-black max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl mx-auto p-4">
      ...
      <p>
        ...
        <a className="text-decoration-none link-primary font-extrabold" href="/help">
          {' '}
          streamarr.com/help
        </a>
      ...
      <p className="mt-6">
        The data controller of your personal information is nickelsh1ts,
        Inc.
      </p>
      ...
      <ul className="list-disc mx-10 my-3">
        ...
        <ul className="list-circle mx-5">
          <li className="my-5">
            your activity on the Streamarr service, such as title selections
            and shows you have watched;
          </li>
          <li className="my-5">
      ...
      <ul className="list-disc mx-10 my-3">
        ...
        <li className="my-5">
            ...
            news about Streamarr, details about new features and content
            available on Streamarr, promotional announcements. These
