...
function Button<P extends ElementTypes = 'button'>(
  ...
  switch (buttonType) {
    case 'primary':
      buttonStyle.push(
        'text-white border border-purple-500 bg-purple-600 bg-opacity-80 hover:bg-opacity-100 hover:border-purple-500 focus:border-purple-700 focus:ring-purple active:bg-opacity-100 active:border-purple-700'
      );
      break;
    case 'danger':
      buttonStyle.push(
    ...
    default:
      buttonStyle.push(
        'text-gray-200 bg-purple-800 bg-opacity-80 border-gray-600 hover:text-white hover:bg-purple-700 hover:border-gray-600 group-hover:text-white group-hover:bg-purple-700 group-hover:border-gray-600 focus:border-blue-300 focus:ring-blue active:text-gray-200 active:bg-gray-700 active:border-gray-600'
      );
  }
