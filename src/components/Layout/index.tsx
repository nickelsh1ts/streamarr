...
const Layout = ({ children }: LayoutProps) => {
  ...
  return (
    <div className="flex h-full min-h-full min-w-0 bg-neutral-900">
      <div className="pwa-only fixed inset-0 z-20 h-1 w-full border-neutral-700 md:border-t" />
      <div className="absolute top-0 h-64 w-full bg-gradient-to-bl from-neutral-800 to-neutral-900">
        <div className="relative inset-0 h-full w-full bg-gradient-to-t from-neutral-900 to-transparent" />
      </div>
