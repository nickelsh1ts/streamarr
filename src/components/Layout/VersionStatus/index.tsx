...
const messages = defineMessages({
  streamdevelop: 'Streamarr Develop',
  streamstable: 'Streamarr Stable',
  ...
  return (
    <Link href="/settings/about">
      <a
        ...
        role="button"
        tabIndex={0}
        className={`mx-2 flex items-center rounded-lg p-2 text-xs ring-1 ring-purple-700 transition duration-300 ${
