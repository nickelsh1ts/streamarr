...
const UserDropdown = () => {
  ...
  return (
    <Menu as="div" className="relative ml-3">
      <div>
        <Menu.Button
          className="flex max-w-xs items-center rounded-full text-sm ring-1 ring-purple-700 hover:ring-purple-500 focus:outline-none focus:ring-purple-500"
      ...
      >
        <Menu.Items className="absolute right-0 mt-2 w-72 origin-top-right rounded-md shadow-lg">
          <div className="divide-y divide-purple-700 rounded-md bg-purple-800 bg-opacity-80 ring-1 ring-purple-700 backdrop-blur">
            <div className="flex flex-col space-y-4 px-4 py-4">
              <div className="flex items-center space-x-2">
                ...
                <div className="flex min-w-0 flex-col">
                  <span className="truncate text-xl font-semibold text-purple-200">
                    {user?.displayName}
                  </span>
