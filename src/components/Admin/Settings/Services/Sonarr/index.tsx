    ...
    <>
      <div className="mt-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:items-center max-sm:space-y-4 max-sm:space-y-reverse max-w-5xl">
        <label htmlFor="service">
          Enable Sonarr<span className="ml-1 text-error">*</span>
        </label>
        ...
        <label htmlFor="SonarrBasePath" className="text-label">
          Sonarr Base Path
        </label>
        <div className="sm:col-span-2">
          <div className="flex">
