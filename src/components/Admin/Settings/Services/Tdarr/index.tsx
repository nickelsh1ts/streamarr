    ...
    <>
      <div className="mt-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:items-center max-sm:space-y-4 max-sm:space-y-reverse max-w-5xl">
        <label htmlFor="service">
          Enable Tdarr<span className="ml-1 text-error">*</span>
        </label>
        ...
        <label htmlFor="TdarrBasePath" className="text-label">
          Tdarr Base Path
        </label>
        <div className="sm:col-span-2">
          <div className="flex">
            ...
            <input
              className="input input-sm input-primary rounded-md w-1/2 rounded-l-none lowercase"
              id="senderName"
              name="senderName"
              type="text"
              placeholder="/admin/tdarr"
            />
          </div>
        </div>
      </div>
