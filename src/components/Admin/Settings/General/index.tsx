...
const GeneralSettings = () => {
  return (
    <form className="mt-6 mb-10 bg-secondary bg-opacity-30 backdrop-blur rounded-md p-4 border border-primary">
      ...
      <div className="mt-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:items-center max-sm:space-y-4 max-sm:space-y-reverse">
        ...
        <div className="col-span-2">
          <div className="flex">
            <SensitiveInput
              ...
              readOnly
            />
            <CopyButton size="sm" textToCopy="Lorem ipsum odor" key={'copy'} />
            <Button
              type="button"
              buttonType="primary"
              buttonSize="sm"
        ...
        <div className="col-span-2">
          <input className="input input-primary input-sm w-full" />
        </div>
