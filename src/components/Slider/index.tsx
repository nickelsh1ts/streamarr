...
const Slider = ({
  ...
  return (
    <div className="relative" data-testid="media-slider">
      <div className="absolute right-0 -mt-10 flex text-purple-400">
        <button
          className={`${
            scrollPos.isStart ? 'text-purple-800' : 'hover:text-white'
          }`}
        ...
        <button
          className={`${
            scrollPos.isEnd ? 'text-purple-800' : 'hover:text-white'
          }`}
      ...
      >
        ...
        {isEmpty && (
          <div className="mt-16 mb-16 text-center font-medium text-purple-400">
            {emptyMessage
              ? emptyMessage
