...
const messages = defineMessages({
  logs: 'Logs',
  logsDescription:
    'You can also view these logs directly via <code>stdout</code>, or in <code>{appDataPath}/logs/streamarr.log</code>.',
  time: 'Timestamp',
  level: 'Severity',
  label: 'Label',
  message: 'Message',
            ...
            <>
              ...
              {activeLog.log?.data && (
                <div className="form-row">
                  ...
                  <div className="col-span-2 mb-1 text-sm font-medium leading-5 text-neutral-400 sm:mt-2">
                    <code className="block max-h-64 w-full overflow-auto whitespace-pre bg-neutral-800 px-6 py-4 ring-1 ring-neutral-700">
      ...
      <div className="mb-2">
        ...
        <div className="mt-2 flex flex-grow flex-col sm:flex-grow-0 sm:flex-row sm:justify-end">
          <div className="mb-2 flex flex-grow sm:mb-0 sm:mr-2 md:flex-grow-0">
            <span className="inline-flex cursor-default items-center rounded-l-md border border-r-0 border-neutral-500 bg-purple-800 px-3 text-sm text-neutral-100">
