...
const messages: { [messageName: string]: MessageDescriptor } = defineMessages({
  ...
  jobs: 'Jobs',
  jobsDescription:
    'streamarr performs certain maintenance tasks as regularly-scheduled jobs, but they can also be manually triggered below. Manually running a job will not alter its schedule.',
  jobname: 'Job Name',
  jobtype: 'Type',
  ...
  cache: 'Cache',
  cacheDescription:
    'streamarr caches requests to external API endpoints to optimize performance and avoid making unnecessary API calls.',
  ...
  imagecacheDescription:
    'When enabled in settings, streamarr will proxy and cache images from pre-configured external sources. Cached images are saved into your config folder. You can find the files in <code>{appDataPath}/cache/images</code>.',
