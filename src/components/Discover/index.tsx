  ...
  return (
    <>
      ...
      {hasPermission(Permission.ADMIN) && (
        <>
          {isEditing && (
            <div className="my-6 rounded-lg bg-purple-800">
              <div className="flex items-center space-x-2 rounded-t-lg border-t border-l border-r border-purple-800 bg-purple-900 p-4 text-lg font-semibold text-purple-400">
          ...
          >
            <button
              ...
              className="h-12 w-12 rounded-full border-2 border-purple-600 bg-purple-700 bg-opacity-90 p-3 text-purple-400 shadow transition-all hover:bg-opacity-100"
            >
          ...
          <Transition
            ...
            className="safe-shift-edit-menu fixed right-0 left-0 z-50 flex flex-col items-center justify-end space-x-0 space-y-2 border-t border-purple-700 bg-purple-800 bg-opacity-80 p-4 backdrop-blur sm:bottom-0 sm:flex-row sm:space-y-0 sm:space-x-3"
          >
            <Button
              buttonType="default"
