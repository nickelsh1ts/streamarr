      ...
      <div className="space-y-6">
        {((data?.mediaInfo?.downloadStatus ?? []).length > 0 ||
          ...
          <div>
            ...
            <div className="overflow-hidden rounded-md border border-purple-700 shadow">
              <ul>
                {data.mediaInfo?.downloadStatus?.map((status, index) => (
                  ...
                  >
                    <li className="border-b border-purple-700 last:border-b-0">
              ...
              <div className="space-y-2">
                {(watchData?.data || data.mediaInfo?.tautulliUrl) && (
                  <div>
                    {!!watchData?.data && (
                      <div
                        className={`grid grid-cols-1 divide-y divide-purple-700 overflow-hidden border-purple-700 text-sm text-purple-300 shadow ${
                          data.mediaInfo?.tautulliUrl
                            ? 'rounded-t-md border-x border-t'
                            : 'rounded-md border'
                        }`}
                      >
                        <div className="grid grid-cols-3 divide-x divide-purple-700">
                                  ...
                                  <a className="z-0 mb-1 -mr-2 shrink-0 hover:z-50">
                                    ...
                                    >
                                      <img
                                        ...
                                        className="h-8 w-8 scale-100 transform-gpu rounded-full object-cover ring-1 ring-purple-500 transition duration-300 hover:scale-105"
                                      />
                                    </Tooltip>
                                  </a>
                                </Link>
