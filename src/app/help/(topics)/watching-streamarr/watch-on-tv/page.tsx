  ...
  return (
    <>
      ...
      <ul className="list list-decimal ms-14 my-4">
        <li>Open the Plex or {process.env.NEXT_PUBLIC_APP_NAME} app</li>
      ...
      <ul className="list list-disc ms-14 my-4">
        ...
        <li>
          Ensure the mobile device with {process.env.NEXT_PUBLIC_APP_NAME} and
      ...
      <ul className="list list-disc ms-10 my-4">
        ...
        <li>
          Ensure the iOS device with {process.env.NEXT_PUBLIC_APP_NAME} and the
  ...
  return (
    <section className="text-neutral bg-zinc-100 py-5">
      <Breadcrumbs
        ...
        names={`Watching ${process.env.NEXT_PUBLIC_APP_NAME},How can I watch ${process.env.NEXT_PUBLIC_APP_NAME} on my TV?`}
      />
      <HelpCard
        heading={`How can I watch ${process.env.NEXT_PUBLIC_APP_NAME} on my TV?`}
        subheading={`You can use Chromecast or Apple AirPlay to wirelessly stream ${process.env.NEXT_PUBLIC_APP_NAME} content from your Android or iOS mobile device to your TV or play directly on some supported devices such as Apple or Google TV with the Plex app`}
        anchors={anchors}
        content={<HelpContent />}
      />
    </section>
