...
const Heading = () => {
  ...
  return (
    <>
      How to download the{' '}
      <span className="text-primary">{currentSettings.applicationTitle}</span>{' '}
      app
    </>
  );
};
      ...
      content: (
        <>
          ...
          <ul className="list ms-4 list-decimal my-4">
            ...
            <li>Browse to the {currentSettings.applicationTitle} website.</li>
          ...
          <ul className="list ms-4 list-decimal my-4">
            ...
            <li className="place-items-center">
              ...
              <span className="font-bold">
                Uninstall {currentSettings.applicationTitle}
              </span>{' '}
              <ChevronRightIcon className="w-3 h-3 inline-flex" />{' '}
            ...
            <ul className="list list-disc ms-6">
              <li className="place-items-center">
                To delete app data from Chrome, select &quot;Also delete data
                from Chrome.&quot;
              </li>
            </ul>
          </ul>
      ...
      content: (
        <>
          ...
          <ul className="list ms-4 list-decimal my-4">
            ...
            <li>Navigate to the {currentSettings.applicationTitle} website.</li>
            <ul className="list list-disc ms-6">
              <li>
                Microsoft Edge will prompt you with the possibility of
                installing the application on the right hands side of the
                address bar.
              </li>
              <li>
          ...
          <ul className="list ms-4 list-decimal my-4">
            ...
            <li>
              Select <span className="font-bold">Details</span> on the card of
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <ul className="list ms-4 list-decimal my-4">
            <li>
              On the bottom right corner, tap on the menu button denoted by
          ...
          <p className="italic text-sm my-4">
            ...
            device, it will launch on Edge; otherwise, it will launch on the
            other browser that is set as the default browser, which would most
            probably be Google Chrome on an Android device.
          </p>
        </>
      ),
    },
      ...
      content: (
        <>
          ...
          <ul className="list ms-4 list-decimal my-4">
            ...
            <li className="">
              Navigate to the {currentSettings.applicationTitle} website.
            </li>
            <li className="place-items-center">
              Tap the Hamburger menu{' '}
              <Bars3Icon className="w-5 h-5 inline-flex" />.
            </li>
          ...
          <ul className="list list-decimal ms-4 my-4">
            ...
            <li>
              Tap Remove from Home Screen to keep it in App Library, or tap
        ...
        <>
          ...
          <ul className="list ms-4 list-decimal my-4">
            ...
            <li className="">
              ...
              <ChevronRightIcon className="w-3 h-3 inline-flex" /> Add to Dock.
              Or click the Share button{' '}
              <ArrowUpOnSquareIcon className="w-5 h-5 inline-flex align-baseline" />{' '}
              in the Safari toolbar, then choose Add to Dock.
            </li>
            <li className="place-items-center">
              Type the name that you want to use for the web app, then click
              Add. The web app is saved to the Applications folder of your home
              folder, and you can open it from the Dock, Launchpad, or
              Spotlight.
            </li>
          </ul>
      ...
      content: (
        <>
          ...
          <ul className="list ms-4 list-decimal my-4">
            ...
            <li>
              Scroll down the share sheet past the rows of contacts and apps,
  ...
  return (
    <section className="text-neutral bg-zinc-100 py-5">
      <Breadcrumbs
        ...
        names={`Getting Started,How to download the ${currentSettings.applicationTitle} app`}
      />
      <HelpCard
        heading={<Heading />}
