...
| **Audiobooks**    | Sidebar and mobile menu | Audiobookshelf is enabled and user has **Audiobooks** or **Reader** permission |
| **Bookmark**      | Sidebar and mobile menu | Shelfmark is enabled and user has **Bookmark** or **Reader** permission        |
